  ...
  return (  
    <div className="card shadow m-4" style={{width: '18rem'}}>
      <div className="card-header d-flex flex-row justify-content-between align-items-center m-0">
          ...
          <button className="btn btn-primary p=0" type='button'data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" onClick={()=>updateOffCanvas(game, currentButton)}><i className="fa-solid fa-circle-info"></i></button>
      </div>
